                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="finish_date" class="form-control modal-simple-text" id="proj_finish_date" value="{{ optional($project->finish_date)->format('Y-m-d H:i') }}">
